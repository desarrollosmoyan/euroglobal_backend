...
use Domain\Employees\Contracts\Repositories\EmployeeWorkingHoursRepository as EmployeeWorkingHoursRepositoryInterface;
...
class EmployeesDomainServiceProvider extends ServiceProvider implements DeferrableProvider
{
    ...
    public function provides(): array
    {
        return [
            ...
            EmployeeWorkingHoursRepositoryInterface::class,
    ...
    public function register(): void
    {
        ...
        $this->app->bind(EmployeeWorkingHoursRepositoryInterface::class, EmployeeWorkingHOursRepository::class);
