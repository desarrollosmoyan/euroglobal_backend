...
use Domain\Gyms\Contracts\Repositories\GymSubscriptionPaymentsRepository as RepositoryInterface;
...
class GymSubscriptionPaymentsRepository extends Repository implements RepositoryInterface
{
    //region Constructor And Fields

    /**
     * @var GymSubscriptionPayment
     */
    private GymSubscriptionPayment $entity;

    /**
     * @param GymSubscriptionPayment $entity
     */
    public function __construct(GymSubscriptionPayment $entity)
    {
        $this->entity = $entity;
    }
    ...
    {
        $query = $this->getEntity()->newQuery()->select('gym_subscription_payments.*');
     ...
     */
    public function getEntity(): GymSubscriptionPayment
    {
        return $this->entity;
    }
