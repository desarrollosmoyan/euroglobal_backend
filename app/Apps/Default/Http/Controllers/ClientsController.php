...
class ClientsController extends Controller
{
     ...
     * @return JsonResponse
     */
    public function makePartner(Request $request, int $id): JsonResponse
    {
        $response = $this->clientsService->makePartner($id);
        if ($response->isSuccess()) {
            return $this->apiOkResponse($response->getData(),['Successfully assigned partner number']);
        }

        return $this->apiErrorResponse([], $response->getErrors());
    }
}
