...
class GymSubscriptionsController extends Controller
{
     ...
     * @return JsonResponse
     */
    public function payQuota(int $id): JsonResponse
    {
        return $this->executeAction(
            fn() => $this->apiOkResponse($this->gymsService->payQuota($id))
        );
    }
     ...
     * @return JsonResponse
     */
    public function makeVersion(Request $request): JsonResponse
    {
        return $this->executeAction(
            fn () => $this->apiOkResponse($this->gymsService->makeVersion($request->all()))
        );
    }
}
