...
Route::group(['middleware' => 'auth:api'], static function () {
    ...
    Route::group([
        ...
        Route::put('/make-partner/{id}', 'ClientsController@makePartner');
    });
    ...
    Route::group([
        'prefix' => 'employee-working-hours',
        'namespace' => 'Apps\Default\Http\Controllers\\',
    ], static function () {
        Route::get('/{id}', 'EmployeeWorkingHoursController@show');
        Route::post('/search', 'EmployeeWorkingHoursController@search');
        Route::post('/create', 'EmployeeWorkingHoursController@create');
        Route::post('/create-range', 'EmployeeWorkingHoursController@createRange');
        Route::delete('/delete', 'EmployeeWorkingHoursController@delete');
        Route::put('/update', 'EmployeeWorkingHoursController@update');
    });
    ...
    Route::group([
        ...
        Route::post('/production-report-excel', 'OrdersController@productionReportExcel');
        Route::post('/summarized-production-report', 'OrdersController@summarizedProductionReport');
        Route::post('/summarized-production-report-excel', 'OrdersController@summarizedProductionReportExcel');
    ...
    Route::group([
        ...
        Route::post('/pay-quota/{id}', 'GymSubscriptionsController@payQuota');
        Route::delete('/delete', 'GymSubscriptionsController@delete');
        Route::put('/update', 'GymSubscriptionsController@update');
        Route::patch('/make-version', 'GymSubscriptionsController@makeVersion');
    });
    ...
    // Gym Subscription Notes
    Route::group([
        'prefix' => 'gym-subscription-notes',
        'namespace' => 'Apps\Default\Http\Controllers\\',
    ], static function () {
        Route::get('/{id}', 'GymSubscriptionNotesController@show');
        Route::post('/search', 'GymSubscriptionNotesController@search');
        Route::post('/create', 'GymSubscriptionNotesController@create');
        Route::delete('/delete', 'GymSubscriptionNotesController@delete');
        Route::put('/update', 'GymSubscriptionNotesController@update');
    });

    // Gym Subscription Payments
    Route::group([
        'prefix' => 'gym-subscription-payments',
        'namespace' => 'Apps\Default\Http\Controllers\\',
    ], static function () {
        Route::get('/{id}', 'GymSubscriptionPaymentsController@show');
        Route::post('/search', 'GymSubscriptionPaymentsController@search');
        Route::post('/create', 'GymSubscriptionPaymentsController@create');
        Route::delete('/delete', 'GymSubscriptionPaymentsController@delete');
        Route::put('/update', 'GymSubscriptionPaymentsController@update');
    });

    // Gym Subscription Payment Details
    Route::group([
        'prefix' => 'gym-subscription-payment-details',
        'namespace' => 'Apps\Default\Http\Controllers\\',
    ], static function () {
        Route::get('/{id}', 'GymSubscriptionPaymentDetailsController@show');
        Route::post('/search', 'GymSubscriptionPaymentDetailsController@search');
        Route::post('/create', 'GymSubscriptionPaymentDetailsController@create');
        Route::delete('/delete', 'GymSubscriptionPaymentDetailsController@delete');
        Route::put('/update', 'GymSubscriptionPaymentDetailsController@update');
    });

    // Gym Subscription Version
    Route::group([
        'prefix' => 'gym-subscription-version',
        'namespace' => 'Apps\Default\Http\Controllers\\',
    ], static function () {
        Route::get('/{id}', 'GymSubscriptionVersionController@show');
        Route::post('/search', 'GymSubscriptionVersionController@search');
        Route::post('/create', 'GymSubscriptionVersionController@create');
        Route::delete('/delete', 'GymSubscriptionVersionController@delete');
        Route::put('/update', 'GymSubscriptionVersionController@update');
    });
    ...
    // Salt Room Reservations
    Route::group([
        'prefix' => 'salt-room-reservations',
        'namespace' => 'Apps\Default\Http\Controllers\\',
    ], static function () {
        Route::post('/search', 'SaltRoomsReservationsController@search');
        Route::post('/summary', 'SaltRoomsReservationsController@summary');
        Route::post('/create', 'SaltRoomsReservationsController@create');
        Route::patch('/mark-as-used', 'SaltRoomsReservationsController@markAsUsed');
        Route::put('/update', 'SaltRoomsReservationsController@update');
        Route::delete('/delete', 'SaltRoomsReservationsController@delete');
        Route::get('/schedules-pdf/{date}', 'SaltRoomsReservationsController@schedulesPdf');
        Route::get('/{id}', 'SaltRoomsReservationsController@show');
        Route::post('/send-email', 'SaltRoomsReservationsController@sendEmail');
    });
